...
```{r}
#instead of counting the number of datapoints per bin, R can give the probability densities by using freq=FALSE
hist(mpg,freq=FALSE,main="my histogram")

#prob=T changes the y-axis from frequency counts to probability (to create density curves)
...
```{r}
plot(hp, mpg,xlab = "Gross horsepower", ylab="Miles/(US) gallon", las=1, col="red", xlim=c(0,400), pch=8) 
#pch (symbol type)
