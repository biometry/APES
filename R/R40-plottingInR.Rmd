...
* The standard graphic device 
* ggplot2 

We will concentrate on the standard graphics here. For creating graphics with ggplot2, see [here](http://www.cookbook-r.com/Graphs/)

Other graph engines that could be called from R include [https://plot.ly/r/](https://plot.ly/r/) , [http://gallery.rcpp.org/articles/matplotlib-from-R/](http://gallery.rcpp.org/articles/matplotlib-from-R/)
