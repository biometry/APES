...
We will concentrate on the standard graphics here. For creating graphics with ggplot2, see 

* http://www.cookbook-r.com/Graphs/

Other graph engines that could be called from R include https://plot.ly/r/ , http://gallery.rcpp.org/articles/matplotlib-from-R/
...
* http://www.plosbiology.org/article/comments/info:doi/10.1371/journal.pbio.1002128
